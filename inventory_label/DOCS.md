...
## What changed in v0.2.06

This version makes the field manager collapsible by default and adds move up/down controls so fields can be reordered inside the active label profile.
